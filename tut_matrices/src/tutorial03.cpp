...
int main( void )
{
    ...
    //--------------------------All related to opening a window---------------------------
    ...
    do{
        ...
        //I have enabled the vertex array. This is the one that gets drawn when you say draw arrays.
        ...
        glBindBuffer(GL_ARRAY_BUFFER, colorbuffer);
        glVertexAttribPointer(
            1,          //attribute. No particular reason for 1, but it must match the layout in the shader.
            3,          // size
            GL_FLOAT,   // type
            GL_FALSE,   // normalized?
            0,          // stride
